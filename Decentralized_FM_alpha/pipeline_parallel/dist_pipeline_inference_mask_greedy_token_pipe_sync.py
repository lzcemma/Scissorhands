...
class DistGreedyInferenceMaskTokenPipeSync(DistGreedyInferenceTokePipeSync):
    ...
    def _get_embedding_size(self):
        ...
        elif self.model_type in ["opt", "opt-save", "opt-ml-att-sparse", "opt_dropkv"]:
    ...
    def _create_layers(self):
        ...
        elif self.model_type == "opt_dropkv":
            from modules.hf_opt_dropkv import GPTEmbeddings, GPTBlock, GPTLMHead
        elif self.model_type == "yalm":
    ...
    def _copy_initial_token_emb(self, index):
        ...
        for k in range(self.num_completions):
            ...
            self.output_token_emb[buff_i][pos + k * self.token_micro_batch_size] = (
