...
output_file=./c4_val/output_c4_val_opt_66b_dropkv.jsonl
eval_file=./c4_val/eval_c4_val_opt_66b_dropkv.txt
    
echo "start running ${file}"

export LRU_WINDOW=100
export POSITION_WINDOW=10
LRU_WINDOW=100
POSITION_WINDOW=10


ARGS="--model-name /lustre/fsw/nvresearch/ldm/diffusion/checkpoint/opt-66b-new \
--model-type opt_dropkv \
--seed 42 \
--fp16 \
--num-layers 8 \
--max-layers 64 \
